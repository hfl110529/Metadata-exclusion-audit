...
| Native retrieval/update software used in the experiments | LlamaIndex core 0.12.27/0.12.28, Haystack 2.31.0, Hayhooks 1.24.0 and FAISS 1.15.1. Install official packages under their upstream licenses. This repository contains experiment-specific checks rather than their runtime distributions. |
